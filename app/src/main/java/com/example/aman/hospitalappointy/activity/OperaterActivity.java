...
import com.example.aman.hospitalappointy.adapter.GridAdatper;
...
import static com.example.aman.hospitalappointy.activity.Oprate.*;
import static com.example.aman.hospitalappointy.activity.Oprate.TEXT_ALARM;
...
//                    sendMsg(message, 1);
                    ...
                    titleBleInfo.setText("deviceNumber：" + deviceNumber + ",deviceVersion：" + deviceVersion + ",\ndeviceTestVersion：" + deviceTestVersion);
                }
