package com.example.aman.hospitalappointy.adapter;
...
public class ListViewAdatper extends BaseAdapter {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        if (null == convertView) {
            convertView = mLayoutInflater.inflate(R.layout.setting, null);
            textViewHold = new TextViewHold();
            textViewHold.mTView = (TextView) convertView.findViewById(R.id.nav_setting);
